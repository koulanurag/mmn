...
class BNNet(nn.Module):
    ...
    def __init__(self, input_size, x_features):
        ...
        self.bin_encoder = nn.Sequential(TernaryTanh())
...
class BinaryGRUNet(nn.Module):
    ...
    def transact(self, o_x, hx_x):
        ...
        hx_x = self.gru_net.transact(o_x, self.bhx_net.decode(hx_x))
...
def get_args():
    ...
    parser.add_argument('--result_dir', default=os.path.join(os.getcwd(), 'results', 'Tomita', 'Ternary_GRU'),
