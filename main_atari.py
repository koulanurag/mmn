...
#         self.env = env
#
#     def generate_train_data(self, no_batches, batch_size, trajectories_data_path):
...
#                             args.batch_size, args.train_epochs, args.cuda, grad_clip=5, target_net=target_net, env=env,
#                             low=-0.02, high=0.02)
...
#             bgru_net = gru_nn.train(bgru_net, env, optimizer, bgru_net_path, bgru_plot_dir, train_data, args.batch_size,
...
#             bgru_net = bgru_nn.train(bgru_net, env, optimizer, bgru_net_path, bgru_plot_dir, train_data, 5,
#                                      args.train_epochs, args.cuda, test_episodes=1, trunc_k=100)
