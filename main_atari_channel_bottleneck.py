...
class GRUNet(nn.Module):
    ...
    def forward(self, input, input_fn=None, hx_fn=None, inspect=False):
        ...
        if input_fn is not None:
            ...
            # input = c_input.view(-1, self.input_c_features)
            # input_x = c_input.view(-1, self.input_c_features)
...
def generate_bottleneck_data(net, env, episodes, save_path, cuda=False, eps=0.2):
    ...
    try:
        ...
        if args.ox_test or args.ox_train:
            ...
            if args.ox_train:
                ...
                optimizer = optim.Adam(ox_net.parameters(), lr=1e-2, weight_decay=0)
